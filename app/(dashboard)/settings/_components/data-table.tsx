...
interface DataTableProps<TData, TValue> {
  columns: ColumnDef<InvoiceType, TValue>[];
  data: InvoiceType[];
  filterKey: string;
}

export function InvoiceTable<InvoiceType, TValue>({
  columns,
  data,
  filterKey,
}: DataTableProps<InvoiceType, TValue>) {
  ...
  return (
    <div>
      <div className="w-full mb-3">
        <Input
          placeholder="Filter invoice by plan..."
