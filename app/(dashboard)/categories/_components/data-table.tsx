...
interface DataTableProps<TData, TValue> {
  columns: ColumnDef<CategoryType, TValue>[];
  data: CategoryType[];
  filterKey: string;
...
export function CategoryTable<CategoryType, TValue>({
  columns,
  data,
  filterKey,
  onDelete,
  disabled,
}: DataTableProps<CategoryType, TValue>) {
  ...
  return (
    <div>
      <div className="flex flex-row gap-y-2 md:gap-y-0 items-center py-4 justify-between">
        <Input
